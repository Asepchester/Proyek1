    ...
    if(isset($_POST['submit'])){
        ...
        if($_POST['city']==''){
            ...
            echo "empty input, write a city name";
             ...
             $data = file_get_contents("https://api.openweathermap.org/data/2.5/weather?q=%22".$city."%22&appid=cbe439ed5d7e9fd4dee89b0183fa437d");
             ...
             $fullWeather = "The weather in ".$city." is ",$weather['weather'][0]['main']." and temprateure is ".$tempInCel." C";
        }
    }
